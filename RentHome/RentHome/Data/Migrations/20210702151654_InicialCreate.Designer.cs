...
namespace RentHome.Data.Migrations
{
    ...
    [Migration("20210702151654_InicialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentHome.Data.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("RentHome.Data.Models.Contract", b =>
                {
                    b.HasOne("RentHome.Data.Models.User", "Manager")
                        .WithMany("Contracts")
            ...
            modelBuilder.Entity("RentHome.Data.Models.Property", b =>
                {
                    ...
                    b.HasOne("RentHome.Data.Models.User", "Owner")
                        .WithMany("Properties")
            ...
            modelBuilder.Entity("RentHome.Data.Models.Rental", b =>
                {
                    ...
                    b.HasOne("RentHome.Data.Models.User", "Tenant")
                        .WithMany("Rentals")
            ...
            modelBuilder.Entity("RentHome.Data.Models.Request", b =>
                {
                    ...
                    b.HasOne("RentHome.Data.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
